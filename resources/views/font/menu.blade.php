...
<section class="menu section-padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="menu-thumb">
                    <img src="{{ asset('fontend') }}/images/breakfast/lucas-swennen-1W_MyJSRLuQ-unsplash.jpg" class="img-fluid menu-image" alt="">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="menu-thumb">
                    <img src="{{ asset('fontend') }}/images/lunch/louis-hansel-cH5IPjaAYyo-unsplash.jpg" class="img-fluid menu-image" alt="">
            ...
            <div class="col-lg-6 col-12">
                <div class="menu-thumb">
                    <img src="{{ asset('fontend') }}/images/lunch/louis-hansel-rheOvfxOlOA-unsplash.jpg" class="img-fluid menu-image" alt="">
...
<section class="menu section-padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="menu-thumb">
                    <img src="{{ asset('fontend') }}/images/dinner/farhad-ibrahimzade-isHUj3N0194-unsplash.jpg" class="img-fluid menu-image" alt="">
